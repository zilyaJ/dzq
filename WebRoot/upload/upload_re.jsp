...
<%
	...
	try 
	{
		   ...
		   if (myFile.isMissing())
		   {
			  out.println("<script language=javascript>alert('please select a picture');   history.back(-1);</script>");
			  return;
		   ...
		   else 
		   {
			   ...
			   //{
				  //out.println("<script language=javascript>alert('control the size of the picture to be in 10k-1M！');   history.back(-1);</script>");
				  //return;
			   //}
               //else
               //{
...
<script language="javascript">
    document.write("Upload successfully");
