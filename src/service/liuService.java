...
public class liuService
{
	...
	public static List goodsNew()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				goods.setId(rs.getInt("id"));
				goods.setBianhao(rs.getString("biaohao"));
	...
	/*public static Tzhishi getZhishi(int id)
	{
		Tzhishi zhishi=new Tzhishi();
		...
		try
		{
			...
			while(rs.next())
			{
				zhishi.setId(rs.getInt("id"));
				zhishi.setBiaoti(rs.getString("biaoti"));
				zhishi.setNeirong(rs.getString("neirong"));
				zhishi.setFujian(rs.getString("fujian"));
				zhishi.setFujianYuanshiming(rs.getString("fujianYuanshiming"));
				zhishi.setShijian(rs.getString("shijian"));
		    }
			rs.close();
		}
		catch(Exception e)
